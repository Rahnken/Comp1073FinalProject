...
function getDetails(){
    ...
    if (background == "" || specialty == "" || trait == "" || charIdeals =="" || bond == "" || flaw == ""){
        ...
        fetch("../json/backgrounds.json")
            ...
            .then(() => document.getElementById('character_bio').innerHTML = "Feature = " + feature_result+"<br><br>")
            ...
            .then(() => document.getElementById('character_bio').innerHTML += " Specialty = " + specialty_result+"<br><br>")
            ...
            .then(() => document.getElementById('character_bio').innerHTML += " Trait = " + trait_result+"<br><br>")
            ...
            .then(() => document.getElementById('character_bio').innerHTML += " Ideals = " + charIdeals_result+"<br><br>")
            ...
            .then(() => document.getElementById('character_bio').innerHTML += " Bond = " + bond_result+"<br><br>")
            ...
            .then(() => document.getElementById('character_bio').innerHTML += " Flaw = " + flaw_result+"<br><br>")
